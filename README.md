...
Cluster Growth, which iteratively adds blocks to a growing cluster to minimize the bounding box area; and Simulated Annealing, a probabilistic optimization that accepts worse solutions with probability
